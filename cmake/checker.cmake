...
find_path(OPENSSL_INCLUDE_DIR openssl/bn.h
    HINTS ${PC_OPENSSL_INCLUDEDIR} ${PC_OPENSSL_INCLUDE_DIRS})
_CHECK(OPENSSL_INCLUDE_DIR "OPENSSL_INCLUDE_DIR-NOTFOUND" "bn.h")
find_library(OPENSSL_LIBRARY ssl crypto
HINTS ${PC_OPENSSL_LIBDIR} ${PC_OPENSSL_LIBRARY_DIRS})
_CHECK(OPENSSL_LIBRARY "OPENSSL_LIBRARY-NOTFOUND" "libssl.so libcrypto.so")
endif()
